...
\note{Am Beispiel des Weges eines Patienten durch ein Krankenhaus}
 \begin{itemize}
...
\begin{frame}{Exkurs: Warum Python?}
  ...
  \note{Das bezieht sich alles primär auf Bioinformatik\\}
  \note{Medizininformatik: 99\% Windows}
  \begin{columns}
