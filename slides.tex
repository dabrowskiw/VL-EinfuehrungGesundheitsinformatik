 ...
 \begin{itemize}
     ...
     Gruppenarbeit:
      \begin{itemize}
          ...
          \item Frage: Patient kommt mit Tuberkulose in's Krankenhaus (Gruppe A) oder zum Arzt (Gruppe B). Welche Einrichtungen könnten beteiligt sein (direkt oder indirekt), wo werden Patientendaten verarbeitet (personenbezogen/anonym/statistisch)?
     ...
     TODO: Diagramme:
     \begin{itemize}
         \item Krankenkassen/Abrechnung
         \item Meldewesen
         \item Konsiliarlabore/RKI/Resistenztestung
     \end{itemize}
     }
 \end{itemize}
 \only<6-9>{
...
\begin{frame}{Inhalt der Übung}
 \begin{itemize}
     ...
     \item<2-> Grobplan (180 Minuten Übung alle 2 Wochen):
     \note<2->{Abwelchselnd, da sonst zu wenig Zeit für Firmenbesuche.}
     \only<2>{
      \begin{itemize}
        \item KW42: Besuch GKV-Spitzenverband
     ...
     \only<3>{
      \begin{itemize}
        \item \textbf{KW42}: Besuch GKV-Spitzenverband
        \item KW44: Python-Grundlagen, Auswertung von Daten aus molekularer Diagnostik
        \item KW46: Fortgeschrittenere Bilddaten-Auswertung
        \item \textbf{KW48}: Besuch der MicroDiscovery GmbH (Auftragsdatenauswertung, Microarrays)
        \item KW50: Auswertung von Microarray-Daten
        \item \textbf{KW02}: Besuch des RKI (NGS-Lab, Proteomik \& Bioinformatik)
        \item KW04: Auswertung von NGS- und Proteom-Daten
      \end{itemize}
     }
 \end{itemize}
