...
\begin{frame}{Python: Einführende Übungen}
    \begin{itemize}
        \item Übungs-repository auf gitlab: \href{https://github.com/dabrowskiw/UE-EinfuehrungGesundheitsinformatik}UE-EinfuehrungGesundheitsinformatik von dabrowskiw
        \item Erster Schritt: Gitlab-Repo
    \end{itemize}
\end{frame}
