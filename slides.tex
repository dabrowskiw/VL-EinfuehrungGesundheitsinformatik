...
\begin{frame}{Inhalt der Vorlesung (Vorläufig)}
    Was macht Informatik im Gesundheitswesen? \uncover<2->{Am Beispiel eines Patienten mit Tuberkulose oder Krebs.}
    \note{
        Noch nichts fest, hängt ab von:
        \begin{itemize}
            \item Vorkenntnissen und Geschwindigkeit
            \item Interesse - bitte melden, wenn was vertieft werden soll! 
        \end{itemize}
        \begin{itemize}
 ...
 \begin{itemize}
     ...
     \only<4>{\begin{itemize}
        \item Erregernachweise (ELISA, PCR) %ELISA: https://www.labkey.org/Documentation/wiki-page.view?name=elisaTut, https://www.thermofisher.com/de/de/home/life-science/protein-biology/protein-biology-learning-center/protein-biology-resource-library/pierce-protein-methods/overview-elisa/elisa-data-analysis.html
        \item Grundlagen der Arbeit mit \\biologischen Daten 
     \end{itemize}}     
     \item<5-> Bildgebende Verfahren
     \only<5>{\begin{itemize}
        \item Blick in das Gewebe: Ultraschall, Röntgen, \\CT, MRT
        \item Ein wenig Mathematik (Fourier-Transformation)
        \item Bilddatenverarbeitung
     \end{itemize}}
     ...
     \end{itemize}}
     \only<8->{
        \item Exkurs: Ausbruchsaufklärung
        \begin{itemize}
            \item MLST, cgMLST
            \item Fingerübung - stark vereinfachtes Beispiel
        \end{itemize}
     }
 \end{itemize}
 \only<3>{
 ...
 \only<8>{
  \begin{textblock}{10}(7,4.5)
   \begin{figure}[h!]
     \includegraphics[width=6.5cm]{Bilder/ausbruchlogo.jpg}
     \caption{Bild als Reaktion auf EHEC-Ausbruch \cite{ausbruchlogo}}
   \end{figure}
  \end{textblock}
 }
\end{frame}
...
\begin{frame}{Inhalt der Übung}
 \begin{itemize}
    ...
    \item<2-> Firmenbesuche
     \only<3>{
      \begin{itemize}
        \item VmScope GmbH (Digitale Pathologie. 25.10.2019, 09:00-11:00, Charitéplatz 1, 10117 Berlin)
	    \item Berlin Heart GmbH (Systeme zur mechanischen Herzuntrestützung. 15.11.2019 09:00-11:00, Wiesenweg 10, 12247 Berlin)
	    \item Serrala GmbH (Biobanking, Telemedizin. 29.11.2019, 08:30-11:00, Am Borsigturm 12, 13507 Berlin. \textbf{Verpflichtende Anmeldung bis 22.11.2019!})
        \item RKI (NGS-Lab, Proteomik \& Bioinformatik)
        \item Eventuell: gematik (Gesellschaft für Telematikanwendungen der Gesundheitskarte)
      \end{itemize}
     }
 \end{itemize}
\end{frame}
...
\begin{frame}{Benotung}
 \begin{itemize}
     \item<1-> Klausur: $30\%$
     \item<2-> 1 Klein-Projektaufgabe: $30\%$
     \only<3>{
	 	\begin{itemize}
	 	    \item 6 Gruppen je 3-4 Personen, Gruppenfindung bis 18.10.2019
	 	    \item Verbindliche Themendefinition bis 1.11.2019 (Workshop am 18.10.)
			...
			\item Empfehlung: Balancierte Gruppen
		\end{itemize}
	 }
     \item<4-> Übungsaufgaben während des Semesters: $20\%$
	 \only<5>{
		\begin{itemize}
			\item In der Übung: Häkchen, wenn erledigt
			\item Ab $75\%$ der Häkchen: $20\%$-Punkte, darunter prozentual
			\item Häkchen-Risiko: Aufruf, die Aufgabe zu präsentieren
		\end{itemize}
	 }
     \item<6-> Firmen-Testate: $20\%$
     \item<7-> Akzeptierte Verbesserungen an Vorlesung/Handout:
     \begin{itemize}
...
\begin{frame}{Innovationspotential!}
	Was könnte IT tun, um zu unterstützen?
	\begin{itemize}
		\item Zeit: 5-10 Minuten
		\item Im Idealfall: Risiken nennen!
		\item Stichpunkt(e) auf Whiteboard
		\item Fertig: Namensschild auf Bildschirm
	\end{itemize}
	\only<2>{
		Liste: Coming to a repo near you soon!
	}
\end{frame}
...
\begin{frame}{Datenflüsse im Implantateregister}
   \only<1>{\begin{figure}[h!]
    \includegraphics[height=5.5cm, right]{Bilder/Implantateregister.pdf}
     \caption{Dateneinlieferung im Implantateregister. Eigene Abbildung basierend auf \cite{Implantateregister}}
   \end{figure}
   }
...
\begin{frame}{Exkurs: Ausbruchsaufklärung}
    \only<2->{
        \begin{textblock}{9}(1,3)
            \begin{mdframed}[backgroundcolor=white]
                \begin{center}
                    \includegraphics[height=5.2cm]{Bilder/OutbreakLab.jpg}\\
					\vspace{0.3cm}\captionof{figure}{Laborbereich für die DNA-Extraktion}
                \end{center}
            \end{mdframed}
        \end{textblock}
    }
    \only<3->{
        \begin{textblock}{9}(2,3.1)
            \begin{mdframed}[backgroundcolor=white]
                \begin{center}
                    \includegraphics[height=5.2cm]{Bilder/OutbreakCycler.jpg}\\
					\vspace{0.3cm}\captionof{figure}{Cycler für PCR-Reaktion}
                \end{center}
            \end{mdframed}
        \end{textblock}
    }
    \only<4->{
        \begin{textblock}{9}(3,3.2)
            \begin{mdframed}[backgroundcolor=white]
                \begin{center}
                    \includegraphics[height=5.2cm]{Bilder/OutbreakGelkammer.jpg}\\
					\vspace{0.3cm}\captionof{figure}{Gelkammer für PCR-Produktauftrennung}
                \end{center}
            \end{mdframed}
        \end{textblock}
    }
    \only<5->{
        \begin{textblock}{9}(4,3.3)
            \begin{mdframed}[backgroundcolor=white]
                \begin{center}
                    \includegraphics[height=5.2cm]{Bilder/OutbreakGel.jpg}\\
					\vspace{0.3cm}\captionof{figure}{Gel mit EthBR-markierten PCR-Produkten}
                \end{center}
            \end{mdframed}
        \end{textblock}
    }
    \only<6->{
        \begin{textblock}{14}(1,3)
            \begin{mdframed}[backgroundcolor=white]
                \begin{center}
                    \includegraphics[height=5.2cm]{Bilder/OutbreakCases.jpg}\\
					\vspace{0.3cm}\captionof{figure}{Anstieg von Salmonella Bovismorbificans-Fallzahlen in den Niederlanden \cite{MLST}}
                \end{center}
            \end{mdframed}
        \end{textblock}
    }
    \only<7->{
        \begin{textblock}{9.2}(2,3.1)
            \begin{mdframed}[backgroundcolor=white]
                \begin{center}
                    \includegraphics[height=5.2cm]{Bilder/OutbreakTree.jpg}\\
					\vspace{0.3cm}\captionof{figure}{Minimum Spanning Tree des Ausbruchs \cite{MLST}}
                \end{center}
            \end{mdframed}
        \end{textblock}
    }
...
\begin{frame}{Exkurs: Ausbruchsaufklärung}
    \begin{itemize}
        \item Mutationsrate gibt Aufschluss über Verwandtheit 
        \item<2-> Messung Mutationsrate:
	\only<2->{
            \begin{itemize}
				\item Sequenzierung
                \item MLST
